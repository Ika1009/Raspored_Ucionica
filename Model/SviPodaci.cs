    ...
    public class SviPodaci
    {
        ...
        public SviPodaci()
        {
            ...
            sreda = new(new List<List<string>>
            {
                ...
                new List<string>() {"fv", "rdeg", "reg", "reg", "reg", "reg", "reg", "reg", "info", "info", "reg", "reg","reg" ,"info/hem", "reg", "reg","info", "info", "reg", "reg", "reg", "reg","fv", "reg", "reg", "reg", "dreg", "n/f", "n/f/i/r", "reg", "n/i/r", "reg"},
